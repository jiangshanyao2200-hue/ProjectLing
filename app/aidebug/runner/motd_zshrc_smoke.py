...
elif _SCRIPT_AIDEBUG_DIR and (_SCRIPT_AIDEBUG_DIR / "runner" / "motd_zshrc_smoke.py").exists():
...
def main() -> int:
    parser = argparse.ArgumentParser(
        prog="aidebug motd-zshrc-smoke",
        description="Smoke test AITermux motd and zshrc startup chain.",
    )
    ...
    projectling_dir = PROJECTLING_DIR
    projectling_zsh = projectling_dir / "projectling.zsh"
    zsh: dict[str, Any] | None = None
    if not shutil.which("zsh"):
        ...
        zsh_source = str(projectling_zsh)
    else:
        zsh_command = "print ZSHRC_SMOKE_OK"
        expected = {"ZSHRC_SMOKE_OK"}
        zsh_source = "missing"
